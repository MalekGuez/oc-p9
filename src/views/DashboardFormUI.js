      ...
      <div class="row">
        <div class="col-sm">
          <label for="file" class="bold-label">Justificatif</label>
            ...
            <span id="file-name-admin">${bill.fileName != 'null' ? bill.fileName : 'Pas de justificatif'}</span>
            ${bill.fileName != 'null' ?
              `<div class="icons-container"><span id="icon-eye-d" data-testid="icon-eye-d" data-bill-url="${bill.fileUrl}"> ${eyeWhite} </span></div>`
              : 
              ''
            }            
          </div>
